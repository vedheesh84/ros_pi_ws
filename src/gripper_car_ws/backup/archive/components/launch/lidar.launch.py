#!/usr/bin/env python3
"""
LiDAR Launch File for Mobile Manipulator
=========================================
Supports both RPLIDAR and YDLIDAR sensors commonly used with Raspberry Pi.

Usage:
    ros2 launch components lidar.launch.py
    ros2 launch components lidar.launch.py lidar_type:=ydlidar lidar_port:=/dev/ttyUSB0
    ros2 launch components lidar.launch.py lidar_type:=rplidar lidar_port:=/dev/serial/by-id/usb-Silicon_Labs_...
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    elif lidar_type.lower() == 'ldlidar' or lidar_type.lower() == 'ld06':
        # LDLiDAR LD06/LD19 configuration (low-cost alternative)
        ldlidar_node = Node(
